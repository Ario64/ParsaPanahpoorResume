...
public class CreateEducationCommandRequestHandler : IRequestHandler<CreateEducationCommandRequest, Unit>
{
    #region Constructor
    ...
    public async Task<Unit> Handle(CreateEducationCommandRequest request, CancellationToken cancellationToken)
    {
